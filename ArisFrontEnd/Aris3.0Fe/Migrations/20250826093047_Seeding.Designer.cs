...
namespace Aris3._0Fe.Migrations
{
    ...
    [Migration("20250826093047_Seeding")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aris3._0Fe.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountStat = true,
                            Created = new DateTime(2025, 8, 26, 9, 30, 47, 287, DateTimeKind.Utc).AddTicks(3573),
                            Email = "admin@gmail.com",
                            LastUpdated = new DateTime(2025, 8, 26, 9, 30, 47, 287, DateTimeKind.Utc).AddTicks(3573),
                            Password = "admin123",
            ...
            modelBuilder.Entity("Aris3._0Fe.Models.History", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aris3._0Fe.Models.LikedFilms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aris3._0Fe.Models.NotifyMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aris3._0Fe.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 8, 26, 9, 30, 47, 287, DateTimeKind.Utc).AddTicks(3573),
                            MaxDownload = 1,
                            MaxScreen = 1,
                            MonthlyPrice = 74000,
                            Name = "Mobile",
                            ...
                            Resolution = "480p",
                            Type = "Mobile",
                            UpdatedDate = new DateTime(2025, 8, 26, 9, 30, 47, 287, DateTimeKind.Utc).AddTicks(3573)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("Aris3._0Fe.Models.SubscriptionHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SubscriptionMethod")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 9, 26, 9, 30, 47, 287, DateTimeKind.Utc).AddTicks(3573),
                            StartDate = new DateTime(2025, 8, 26, 9, 30, 47, 287, DateTimeKind.Utc).AddTicks(3573),
                            SubscriptionId = 1,
            ...
            modelBuilder.Entity("Aris3._0Fe.Models.SupportedDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aris3._0Fe.Models.WatchList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SubscriptionSupportedDevice", b =>
                {
                    b.Property<int>("SubscriptionsId")
                        .HasColumnType("int");

                    b.Property<int>("SupportedDevicesId")
                        .HasColumnType("int");

                    b.HasKey("SubscriptionsId", "SupportedDevicesId");

                    b.HasIndex("SupportedDevicesId");

                    b.ToTable("SubscriptionSupportedDevices", (string)null);
                });
            ...
            modelBuilder.Entity("SubscriptionSupportedDevice", b =>
                {
                    b.HasOne("Aris3._0Fe.Models.Subscription", null)
                        .WithMany()
                        .HasForeignKey("SubscriptionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Aris3._0Fe.Models.SupportedDevice", null)
                        .WithMany()
                        .HasForeignKey("SupportedDevicesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
