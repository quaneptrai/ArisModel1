...
namespace Aris3._0.Infrastructure.Data.Context
{
    public class ArisDbContextFactory : IDesignTimeDbContextFactory<ArisDbContext>
    {
        public ArisDbContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseSqlServer("Server=db26092.public.databaseasp.net; Database=db26092; User Id=db26092; Password=585810quan; Encrypt=False; TrustServerCertificate=True; MultipleActiveResultSets=True;");
