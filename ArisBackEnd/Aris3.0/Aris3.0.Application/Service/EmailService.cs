...
public class EmailService : IEmailService
{
    ...
    public async Task<string> SenEmail(string email)
    {
        ...
        try
        {
            string clientId = "347817540443-r7c08k7nj90srv2e7ssrtisossg3feeg.apps.googleusercontent.com";
            string clientSecret = "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";
            string refreshToken = "1//044n-B849gs4pCgYIARAAGAQSNwF-L9Ir0Zdh8VdNErs7BAMlFcYhDaMe3EmflLF1jun-5UBmiXBPLdk1t_QH5uSRxYQH8R9HIM0";
